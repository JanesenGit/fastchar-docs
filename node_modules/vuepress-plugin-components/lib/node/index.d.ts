...
/** @deprecated Please use '@vuepress/plugin-back-to-top' */
type BackToTopLocaleConfig = ExactLocaleConfig<BackToTopLocaleData>;
...
export { AVAILABLE_SERVICES, type ArtPlayerOptions, type AvailableComponent, type BackToTopLocaleConfig, type BackToTopLocaleData, type BackToTopOptions, type BuiltInFontIcon, type BuiltInShareService, type ComponentPluginOptions, type DeprecatedComponent, type FontIconAssets, type FontIconOptions, type NoticeActionOption, type NoticeClientOptions, type NoticeItemOptions, type NoticeOptions, type PDFLocaleConfig, type PDFLocaleData, SHARE_CONFIG, type ShareAction, type ShareService, type ShareServiceConfig, type ShareServiceOptions, type ShareServiceVariableName, type SiteInfoLocaleConfig, type SiteInfoLocaleData, type VidstackLocaleConfig, type VidstackLocaleData, backToTopLocales, componentsPlugin, pdfLocaleConfig, siteInfoLocaleConfig, vidstackLocales };
