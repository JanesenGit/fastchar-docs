...
`)},M1=(e,t=!0)=>s=>(t&&B1(e),s.env.isDebug&&i.info("Options:",e),J(s,{id:"hope"}),{name:S,define:E1(e,t),extendsBundlerOptions:(o,r)=>{e?.components?.includes("ArtPlayer")&&R(o,r,"artplayer"),e?.components?.includes("VidStack")&&G(o,r,/^media-/),K(o,r,["@vuepress/helper","vuepress-shared"])},clientConfigFile:o=>O1(o,e,t)});export{A as AVAILABLE_SERVICES,h as SHARE_CONFIG,B as backToTopLocales,M1 as componentsPlugin,E as pdfLocaleConfig,O as siteInfoLocaleConfig};
