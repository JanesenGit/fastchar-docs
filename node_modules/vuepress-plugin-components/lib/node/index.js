...
`)},Ne=(e,t=!0)=>a=>(t&&Ve(e),a.env.isDebug&&l.info("Options:",e),Q(a,{id:"hope"}),{name:z,define:Re(e,t),extendsBundlerOptions:(o,r)=>{e?.components?.includes("ArtPlayer")&&U(o,r,"artplayer"),e?.components?.includes("VidStack")&&q(o,r,/^media-/),G(o,r,["@vuepress/helper","vuepress-shared"])},clientConfigFile:o=>Me(o,e,t)});export{O as AVAILABLE_SERVICES,u as SHARE_CONFIG,L as backToTopLocales,Ne as componentsPlugin,V as pdfLocaleConfig,R as siteInfoLocaleConfig,M as vidstackLocales};
